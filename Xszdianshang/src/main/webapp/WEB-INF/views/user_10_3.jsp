				...
				<div class="user_coment">
					<!-- <div class="user_address">
                     ...
                     <dl>
                          ...
                          <dd><input name="sh_name" type="text"  class="youbian" value="长度不超过25个字符" onfocus="if(this.value=='长度不超过25个字符'){this.value='';}"  onblur="if(this.value==''){this.value='长度不超过25个字符';}"/>
                          </dd>
                     </dl>
                     <dl>
                          <dt>手机号码</dt>
					...
					<table width="713" border="0" cellspacing="0" cellpadding="0"
						...
						<%-- <c:forEach items="${addresslist}" var="address"
							...
							<tr>
								...
								<td><div align="center">${address.province} ${address.city} ${address.country}</div></td>
								<td><div align="center">${address.addr_detail}</div></td>
								<td><div align="center">${address.postCode}</div></td>
								<td><div align="center">${address.mobile}</div></td>
								<td><div align="center">
										<a href="zhanghu/editAddress">修改</a>/<a href="zhanghu/deleteAddress">删除</a>
									</div></td>
							</tr>
						</c:forEach> --%>
