			...
			<div class="user_lmt">
				...
				<div class="user_lmt2">
					<div class="user_lmt22">
						<a href=""><img src="images/user_plgm.jpg" width="70"
							height="22" /></a>
					</div>
					<div class="user_lmt22">
						<a href=""><img src="images/user_bt.jpg" width="70"
							height="22" /></a>
					</div>
					<div class="user_lmt21">
						<input name="allxz" type="checkbox" value="" class="allxz_c" />全选
					</div>
				</div>
			</div>
			<div class="user_coment">
					...
					<c:forEach items="${goodlist}" var="good" varStatus="status">
						<tr>
							<td width="32" height="149"
								style="border-right: none; vertical-align: text-top;"><input
								type="checkbox" name="dd_book" id="dd_book" class="dd_book" /></td>
							<td width="163">
								<div class="dd_img">
									<a href="Good/toXq?id=${good.goodsid}" target="_blank"><img
										src="${good.imgurl}" width="132" height="121" /></a>
								</div>

							</td>
							<td colspan="3"><a href="Good/toXq?id=${good.goodsid}"
								target="_blank">${good.goodsname}</a></td>
							<td>20</td>
							<td>
								<div class="user_ck">
				...
				<div class="settlement">
					...
					<div class="settlement_r">
						<span>已选商品<b class="red">2</b>件
						</span> <span> 合计（不含运费）￥<b class="ppr">25.00</b></span> <span
							class="jiesuan"><a href="">结算</a></span>
					</div>
				</div>
				<!--结算结束 -->
			</div>
