		...
		<div class="header_2">
			...
			<div class="srarching">
				<div class="srarching_t">
					<input name="search_txt" type="text" class="search_txt" id="search_txt"
						value="输入关键字"
						onfocus="if(this.value=='输入关键字'){this.value='';}"
						onblur="if(this.value==''){this.value='输入关键字';}" /> <input
			...
			<div class="warp">
				...
				<div class="nav_right">
					<ul>
						...
						<li><a href="Good/getAll">全部书籍</a></li>
						<li><a href="javascript:querendenglv(${user.userid})">购物车</a></li>
						<li><a href="javascript:querendenglv(${user.userid})">我的订单</a></li>
						<li><a href="javascript:querendenglv3(${user.userid})">个人中心</a></li>
						<li><a href="">客户服务</a></li>
					</ul>
					<script type="text/javascript">
					   function querendenglv(userid){
						   if(userid!=null)
							{							
					   ...
					   function querendenglv3(userid){
						   if(userid!=null)
							{							
							  window.location.href="${pageContext.request.contextPath}/zhanghu/";
							}
						   else 
							alert("请先登录哦，亲~");
					   }
...
function search(){
	...
	if(st=="输入关键字"){
		...
		window.location.href="Good/search?st="+st;
	}
