        ...
        <div class="password_b">
             ...
             <div class="password_bc">
                  ...
                  <div class="password_bc2">
                       <div class="password_bc2t">问题一：您最崇拜的人是谁？</div>
                       <div class="password_bc2b"><input type="text" name="password_bc2btxt" class="password_bc2btxt"></div>
                       <div class="password_bc2c"><a href="" target="_blank" class="pass_next">下一步</a></div>
                  </div>
