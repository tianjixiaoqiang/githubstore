    ...
    <div class="user_cont">
         ...
         <div class="user_cont_left">
               <dl>
                   <dt>我的交易</dt>
                   <dd><a href="">我的订单</a></dd>
                   <dd><a href="zhanghu/shoucang">我的收藏</a></dd>
                   <dd><a href="">我的账单</a></dd>
                   <dd><a href="Cart/showcart">我的购物车</a></dd>
               ...
               <dl>
                   <dt>我的账户</dt>
                   <dd  class="active"><a href="zhanghu/jifen">我的积分</a></dd>
		...
		$(this).toggleClass("jia"); return false;
         ...
         <div class="user_cont_right">
           <div class="user_lmt">
                    ...
                    <div class="user_lmt2">
                         <div class="user_lmt21">共有<b class="red">200</b>积分</div>
                    </div>
